...
class TColors {
  static const Color blue = Color(0xff094E8C);
...
class TStyle {
  ...
  static TextStyle style_02 = const TextStyle(
      fontSize: 12.0, color: TColors.blue, fontWeight: FontWeight.w500);
  static TextStyle style_03 =
      const TextStyle(fontSize: 12.0, color: Colors.red, fontWeight: FontWeight.w500);
