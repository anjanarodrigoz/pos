  ...
  void _navigateInvoice(int direction) {
    ...
    setState(() {
      if (direction == -1 && currentIndex.value > 0) {
        currentIndex.value--;
      } else if (direction == 1 && currentIndex.value < invoiceList.length - 1) {
        currentIndex.value++;
                    ...
                    return Obx(() {
                      ...
                      return Column(
                        children: [
                          _buildNavigationBar(),
                          Expanded(
                            child: SaveInvoiceViewPage(invoice: currentInvoice!),
                          ),
                        ],
                      );
                    });
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              final result = await _invoiceRepo.addPayment(
                ...
                amount: amount,
                paymentMethod: InvoiceConverter.paymethodToString(selectedMethod.value),
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              if (result.isSuccess) {
                ...
                _showMessage('Failed to delete invoice: ${result.error?.message}');
              }
            },
            style: ElevatedButton.styleFrom(
